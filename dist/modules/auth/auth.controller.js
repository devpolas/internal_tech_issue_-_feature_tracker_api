...
import { checkJWTToken, createUserIntoDB, loginUserFromDb, sendJWT, } from "./auth.service.js";
...
export const refreshToken = catchAsync(async (req, res) => {
    const result = await checkJWTToken(req.cookies.refresh_token, "refresh_token");
    if (!result) {
